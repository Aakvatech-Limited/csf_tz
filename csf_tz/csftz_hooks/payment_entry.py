...
def validate(self, method):
    ...
    if company.restrict_unallocated_amount_for_supplier or company.restrict_unallocated_amount_for_supplier and self.restrict_unallocated_amount_for_supplier:
