...
doc_events = {
    ...
    "Payment Entry": {
        "before_submit": "csf_tz.csftz_hooks.bank_charges_payment_entry.validate_bank_charges_account",
        "before_submit": "csf_tz.csftz_hooks.bank_charges_payment_entry.create_bank_charges_journal", 
    }
}
