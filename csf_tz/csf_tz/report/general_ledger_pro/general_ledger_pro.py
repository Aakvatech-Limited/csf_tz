...
def get_gl_entries(filters, accounting_dimensions):
	...
	# The Student branch needs the education app; edu_tz owns that integration.
	is_education_installed = "edu_tz" in frappe.get_installed_apps()
	student_filter = "party != 'Student' and " if is_education_installed else ""
